...
@property (assign, nonatomic, readonly) BOOL isAirPurifier;              //空气净化器
...
@property (assign, nonatomic, readonly) BOOL isAirPurifierModeControl;   //空气净化器(自动，手动模式切换)
@property (assign, nonatomic, readonly) BOOL isAirPurifierSecurity;      //空气净化器安防
